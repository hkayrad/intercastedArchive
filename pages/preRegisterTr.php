...
<div class="main">
    ...
    <div class="welcomer">
        <h1 class="title">Intercasted'a ön kayıt yaptır</h1>
        
        <p class="slogan">Paylaşıma hazır hale getirdiğiniz etkileyici videoları insanların canlı izlemesine fırsat verin.</p>
    
        <p class="text">Ön kayıt yaptıran herkese 3 ay boyunca <a href="../pages/premiumTr.php">Premium</a> hediye.</p>
